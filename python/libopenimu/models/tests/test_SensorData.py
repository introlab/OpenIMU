...
class SensorDataTest(unittest.TestCase):
    ...
    def test_to_time_series(self):
        ...
        channel = Channel()
        sensordata.channel = channel
        sensordata.start_timestamp = datetime.datetime.fromtimestamp(datetime.datetime.now().timestamp())
        sensordata.stop_timestamp = datetime.datetime.fromtimestamp(datetime.datetime.now().timestamp())

        sensordata.start_timestamp.timestamp()
