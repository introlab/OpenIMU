...
if __name__ == "__main__":
    ...
    for series in timeseries_acc:
        view_acc.add_data(
            series["x"], series["y"], color=colors.pop(), legend_text=series["label"]
        )
    ...
    for series in timeseries_batt:
        view_batt.add_data(
            series["x"], series["y"], color=Qt.darkGreen, legend_text=series["label"]
        )
    ...
    for series in timeseries_lux:
        view_lux.add_data(
            series["x"], series["y"], color=Qt.darkCyan, legend_text=series["label"]
        )
